        ...
        <section className="flex-center gap-x-3">
          <div className="relative w-max">
            <Image
              ...
              width={1200}
              height={1200}
              className="aspect-square h-auto w-[160px] rounded-full border-2 border-black p-1"
            />

            {/* Edit button */}
            <button className="flex-center absolute bottom-2 right-2 aspect-square rounded-full bg-[#2C50ED] p-2 text-white/95">
              <ImagePlus size={20} />
            </button>
          </div>

          <div>
            <h3 className="text-3xl font-semibold">Moazzem Hossen</h3>
